...
const Chatwidget = () => {
  ...
  const handleNewUserMessage = (newMessage) => {
    ...
    if (
      ...
      addResponseMessage(
        `You can send your number here or can directly contact the owner via +91234568901`
      );
      ...
      addResponseMessage(
        `Sorry, I'm currently learning your language. I don't know the answer. Please contact on this number +91234568901.`
      );
    }
  };
  return (
